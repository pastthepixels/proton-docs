...
class Proton3DScene {
     ...
     * @param { object } extras The parameters for this function. An example: { distance: Proton.Vector3, noPhysics: Boolean, height: Number (optional, in metres), hidePointer: Boolean (optional), xSensitivity: Number, ySensitivity: Number, invisibleParent: Boolean, cameraParent: Proton3DObject, type: "firstperson"|"thirdperson"|"birdseye", distance: Proton.Vector3 (for third person camera control types only), gun: Proton3DObject, gunPosition: Proton.Vector3 }
     */
