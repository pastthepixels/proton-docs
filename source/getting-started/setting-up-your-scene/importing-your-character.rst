...
What this does is it loads the playermodel you made earlier. It loads it with no physics and no shadows, in order to immerse the player into the environment.
